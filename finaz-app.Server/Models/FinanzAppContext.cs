...
namespace finaz_app.Server.Models
{
    public partial class FinanzAppContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.GastoId).HasName("GST_GastoID_PK");
            ...
            {
                entity.HasKey(e => e.IngresoId).HasName("ING_IngresoID_PK");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.CorreoElectronico, "UQ__Usuarios__60695A19A3DBD5FB").IsUnique();
